...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Weather Tag - Google Ads Conversion",
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
...
const endpoint="https://x35r26rxbg.execute-api.eu-west-1.amazonaws.com/prod/gsa/conversion";
...
if (cookie!=undefined)
{
  ...
  let url = encodeUri(endpoint)+"?gclid="+encodeUri(gclid)+"&value="+encodeUri(value);
...
Created on 18.10.2021, 09:16:47
