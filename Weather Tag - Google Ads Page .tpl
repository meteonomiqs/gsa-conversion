...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Weather Tag - Google Ads Page",
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
  ...
  "description": "This tags iis used to enrich Google Ads conversion with meteonomiqs weather information",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "TEXT",
    "name": "apikey",
    "displayName": "meteonomiqs API-Key",
    "simpleValueType": true
  },
  {
    "type": "GROUP",
    "name": "advanced",
    "displayName": "Advanced Cookie Settings",
    ...
    "subParams": [
      {
        ...
        "simpleValueType": true,
        "defaultValue": "_gcl",
        "help": "Set only if Conversion Linker tag is not using default settings"
      }
    ]
  }
]
...
const urlgclid = getUrl('query');


if (urlgclid.indexOf("gclid")!=-1)
{
  
const endpoint="https://x35r26rxbg.execute-api.eu-west-1.amazonaws.com/prod/gsa/adwords";
let script="https://resources.meteonomiqs.com/wdx/gtm-weather/javascript/meteonomiqs_gtm.js";
let CookieName=data.prefix+"_aw";

let cookie = getCookieValues(CookieName);

if (cookie!=undefined)
{
  let gclid=cookie.toString().split(".")[2];
  let url = encodeUri(endpoint)+"?gclid="+encodeUri(gclid);

  injectScript(script, 
               function()
               {
                  callInWindow('sendData', url, data.apikey);   
               }, data.gtmOnFailure);
}
...
Created on 18.10.2021, 09:16:53
